...
describe('isFile', () => {
    describe('Check if file is a directory', () => {
        it('Should return false', async () => {
            const res = await isDir(join(TEST_DIR, 'lorem', 'ipsum', 'test.txt'));
    ...
    describe('Check if directory is a directory', () => {
        it('Should return true', async () => {
            const res = await isDir(join(TEST_DIR, 'lorem'));
            expect(res).toBe(true);
        });
    });
    ...
    describe('Check if deep directory is a directory', () => {
        it('Should return true', async () => {
            const res = await isDir(join(TEST_DIR, 'lorem', 'ipsum'));
            expect(res).toBe(true);
        });
    });
    ...
    describe('Check if not existing path returns false', () => {
        it('Should return false', async () => {
            const res = await isDir(join(TEST_DIR, Math.random().toString()));
            expect(res).toBe(false);
        });
    });
});
